...
public class ProjectResource extends AbstractXmEntityDtoResource<ProjectDTO> {

    @Autowired
    public ProjectResource(XmEntityDtoService xmEntityDtoService, XmEntityService xmEntityService) {
